...
function handleMovement (speed) {
    ...
    console.log('handlemovement', speed)
    //move down
...
function playGame () {
    ...
    //=====list of all rendered walls in room, different from room redraw because laval kills, and these walls are only here to be run into ===//
